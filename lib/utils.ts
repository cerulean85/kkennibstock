...
export function aggregateByWeek(data: { date: string; currentCount: number; cumulativeCount: number }[]) {
...
export function aggregateByMonth(data: { date: string; currentCount: number; cumulativeCount: number }[]) {
  // 월 계산 함수 (YYYY-MM)
