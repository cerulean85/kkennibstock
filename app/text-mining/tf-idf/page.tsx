...
import ViewTfidfResultPopup from "@/components/popup/ViewTfidfResultPopup";
...
const TfidfPage = () => {
  const [itemList, setItemList] = useState<TfidfListItem[]>([]);
  ...
  const [viewItem, setViewItem] = useState<TfidfListItem | null>(null);
  ...
  const filteredData = useMemo(() => {
    return itemList
      ...
      .sort((a, b) => {
        // 정렬
        let aValue = a[sortField as keyof TfidfListItem];
        let bValue = b[sortField as keyof TfidfListItem];
