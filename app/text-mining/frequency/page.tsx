...
import ViewFrequencyResultPopup from "@/components/popup/ViewFrequencyResultPopup";
...
const FrequencyPage = () => {
  const [itemList, setItemList] = useState<FrequencyListItem[]>([]);
  ...
  const [viewItem, setViewItem] = useState<FrequencyListItem | null>(null);
  ...
  const filteredData = useMemo(() => {
    return itemList
      ...
      .sort((a, b) => {
        // 정렬
        let aValue = a[sortField as keyof FrequencyListItem];
        let bValue = b[sortField as keyof FrequencyListItem];
