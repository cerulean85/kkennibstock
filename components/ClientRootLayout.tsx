                      ...
                      return (
                        <div key={pageKey}>
                          ...
                          {currentMenu === Menu.TextMining && pageKey === Page.TextMiningDashboard && (
                            <button
                              type="button"
                              className="w-full flex items-center justify-center gap-2 bg-gradient-to-r from-blue-700 to-blue-500 text-white px-5 py-2 rounded-lg font-bold text-base shadow-md hover:from-blue-900 hover:to-sky-600 focus:outline-none focus:ring-2 focus:ring-blue-300 transition-all duration-200"
