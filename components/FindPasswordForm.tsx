    ...
    <div>
      <div>
        <div className="mt-2 mb-10 text-sm">
          Enter the email that you used when you signed up to recover your password. You will receive a password reset
          link.
        </div>
      </div>
      ...
      <div className="mt-2">
        <button className="btn-main w-full h-[38px] font-bold text-[1.0rem] tracking-wider" onClick={sendResetLink}>
          Send Link
        </button>
      </div>
    </div>
